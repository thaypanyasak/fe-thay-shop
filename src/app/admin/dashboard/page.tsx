...
const DashboardContent = () => {
  ...
  let content;
  if (section === "products") content = <ProductList />;
  else if (section === "categories") content = <Category />;
  else if (section === "brands") content = <Brands />;
  else {
    content = (
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div
        className={`fixed lg:relative lg:translate-x-0 z-50 lg:z-auto w-64 bg-white shadow-lg border-r border-gray-200 h-full lg:h-auto transform transition-transform duration-300 ease-in-out ${
